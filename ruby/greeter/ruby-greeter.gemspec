...
Gem::Specification.new do |spec|
  spec.name = "ruby-greeter"
  spec.version = "1.0.0"
  spec.summary = "Greeter program written in Ruby"
  spec.description = "A Greeter program written in Ruby programming language"
  spec.licenses = ["MIT"]
  spec.homepage = "https://github.com/altersabeh/codes#README"
  spec.authors = ["AlterSabeh"]
  spec.email = ["betamaximum22@gmail.com"]
  spec.bindir = "bin"
  spec.executables = ["ruby-greeter"]
