tasks {
    jar {
        ...
        manifest {
            ...
            attributes("Description" to "${projectDir.name.capitalize()} World program written in Groovy")
        }
    ...
    register<JavaExec>("groovy-${projectDir.name}") {
        description = "${projectDir.name.capitalize()} World program written in Groovy"
